            ...
            <dh-component>
                <nav className="w-full border-b">
                    <div className="py-5 md:py-0 container mx-auto px-6 flex items-center justify-between">
                        ...
                        {/* Agrupar los botones dentro de un div con clase flex */}
                        <div className="flex space-x-4"> {/* Añadir flex para alinear horizontalmente */}
                            {/* Botón para navegar a la página de Sign Up */}
                            <button 
                            ...
                            {/* Botón para navegar a la página de Sign In */}
                            <button 
                                onClick={() => navigate('/signin')}  // Redirige a la página de Sign In
                                className="focus:outline-none lg:text-lg lg:font-bold focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-transparent transition duration-150 ease-in-out hover:bg-gray-200 rounded border border-indigo-700 text-indigo-700 px-4 sm:px-8 py-1 sm:py-3 text-sm">
                                Sign In
                            </button>
                        </div>
                    ...
                    <div className="container mx-auto flex flex-col items-center py-12 sm:py-24">
                        <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col  mb-5 sm:mb-10">
                            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center text-gray-800 font-black leading-7 md:leading-10">
                                ...
                                <span className="text-indigo-700"> SliceTicket</span>
                            </h1>
                            <p className="mt-5 sm:mt-10 lg:w-10/12 text-gray-400 font-normal text-center text-sm sm:text-lg">SliceTicket hace que dividir los gastos dentro de cualquier grupo sea sencillo y sin estrés.</p>
                        </div>
