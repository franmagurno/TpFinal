        ...
        <div className="min-h-screen bg-gray-100 flex flex-col">
            ...
            <main className="flex-grow p-6 bg-gray-100">
                <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
                    <h2 className="text-2xl font-bold text-gray-800 mb-4">Cerrar Balance</h2>
                        ...
                        <table className="min-w-full bg-gray-50 rounded-lg overflow-hidden">
                            <thead>
                                <tr className="bg-gray-200 text-gray-600">
                                    ...
                                    <th className="p-4 text-left">Total Pagado</th>
                                    <th className="p-4 text-left">A Dividir En</th>
                                </tr>
                            </thead>
                            <tbody>
                                {members.map((member, index) => {
                                    ...
                                    return (
                                        <tr key={index} className="border-t">
                                            <td className="p-4 text-gray-800">{member.nombre}</td>
                                            <td className="p-4 text-gray-600">${totalPaid.toFixed(2)}</td>
                                            <td className="p-4 text-gray-600">
                                                <div className="flex items-center">
                                                    <select
                                                        ...
                                                        className="border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring"
                                                    >
                                                    ...
                                                    {divisions[index].type === 'parts' && (
                                                        <input
                                                            ...
                                                            className="ml-2 w-20 p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring"
                                                            placeholder="%"
                                                        />
                                                    )}
                                                </div>
                    ...
                    <div className="flex justify-center mb-6">
                        <button
                            ...
                            className="px-6 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring"
                        >
                            Cerrar Balance
                        </button>
                    </div>
                    ...
                    {balanceDetails.length > 0 && (
                        <div className="mt-6">
                            <h3 className="text-xl font-semibold text-gray-800 mb-4">Resumen de Deudas</h3>
